...
class TaggingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tagging" do
    assert_difference('Tagging.count') do
      post taggings_url, params: { tagging: { created_at: @tagging.created_at, tag_id: @tagging.tag_id, taggable_id: @tagging.taggable_id, taggable_type: @tagging.taggable_type } }
    end
  ...
  test "should update tagging" do
    patch tagging_url(@tagging), params: { tagging: { created_at: @tagging.created_at, tag_id: @tagging.tag_id, taggable_id: @tagging.taggable_id, taggable_type: @tagging.taggable_type } }
